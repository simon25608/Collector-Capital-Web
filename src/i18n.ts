  ...
  en: {
    translation: {
      ...
      legal: {
        ...
        regP1: 'ForexCapital Global Markets is authorized and regulated by the Global Financial Conduct Authority (GFCA) under license number #FC-982-11. We strictly adhere to Anti-Money Laundering (AML) and Know Your Customer (KYC) protocols.',
        ...
        limitationP1: 'In no event shall ForexCapital or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our platform, even if ForexCapital has been notified orally or in writing of the possibility of such damage.',
  ...
  es: {
    translation: {
      ...
      legal: {
        ...
        regP1: 'ForexCapital Global Markets está autorizada y regulada por la Autoridad de Conducta Financiera Global (GFCA) bajo la licencia número #FC-982-11. Nos adherimos estrictamente a los protocolos contra el lavado de dinero (AML) y conozca a su cliente (KYC).',
        ...
        limitationP1: 'En ningún caso ForexCapital o sus proveedores serán responsables de ningún daño (incluidos, entre otros, daños por pérdida de datos o ganancias, o debido a la interrupción del negocio) que surja del uso o la incapacidad de usar los materiales en nuestra plataforma, incluso si ForexCapital ha sido notificado oralmente o por escrito de la posibilidad de tal daño.',
